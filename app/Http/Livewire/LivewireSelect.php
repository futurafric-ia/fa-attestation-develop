...
class LivewireSelect extends Component
{
    ...
    public function styles()
    {
        return [
            ...
            'search' => 'relative',
            'searchInput' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50',
            'searchOptionsContainer' => 'absolute top-0 left-0 mt-12 w-full z-10',

            'searchOptionItem' => 'p-3 hover:bg-primary-600 text-white cursor-pointer text-sm',
    ...
    public function render()
    {
        ...
        return view($this->selectView)->with([
                'options' => $options,
