<x-slot name="breadcrumbs">
    {{ Breadcrumbs::render('attestation.index') }}
</x-slot>

<section x-data="{ displayingSlideover: @entangle('displayingSlideover') }" class="overflow-hidden">

    <x-section-header title="Attestations"></x-section-header>

    <livewire:attestation.attestations-table />

    <div class="absolute inset-0 overflow-hidden z-40" x-show="displayingSlideover" x-cloak>
      <div
            x-show="displayingSlideover"
            ...
            >
                <div class="h-full flex flex-col space-y-6 py-6 bg-white shadow-xl overflow-y-scroll">
                    ...
                    <div class="relative flex-1 px-4 sm:px-6">
                        <div wire:loading wire:target="showDeliveryAttestations">
                        ...
                        <x-tabs :navs="['Informations', 'Livraisons', 'Scans']">
                            <x-tab id="Informations">
                                <div class="px-6 py-5 flex flex-col space-y-2">
                                    ...
                                    <div>
                                        <x-label value="Code de l'approvisionnement" />
                                        <span class="text-gray-700 text-sm">
                                            {{ $attestationBeingDisplayed->supply->code }}
                                        </span>
                                    </div>
                                    <div>
